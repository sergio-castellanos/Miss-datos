...
<header>
    ...
    <div class="sidebar-content">
        <h2>administrador</h2>
        <ul>
            <li><a href="inicio.php">Gestionar empleado</a></li>
            <li><a href="registrar_usuarios.php">Gestionar usuario</a></li>
            <li><a href="incapacidades/incapacidades.php">Incapacidades</a></li>
            <li><a href="permisos/permiso.php">Permisos</a></li>
